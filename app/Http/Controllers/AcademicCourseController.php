...
class AcademicCourseController extends BasePageController
{
    public function show($slug)
    {
        $globals = $this->loadGlobals();

        // Load academic courses data
        $coursesData = json_decode(Storage::get('content/pages/academic-courses.json'), true) ?? [];
        ...
        return view('pages.academic-course', [
            'fonts'  => $globals['fonts'],
