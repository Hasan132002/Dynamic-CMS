...
class FinancialAidController extends BasePageController
{
    public function index()
    {
        $globals = $this->loadGlobals();
        $pageData = json_decode(Storage::get('content/pages/financial-aid.json'), true) ?? [];
        ...
        return view('pages.financial-aid', [
            'fonts'  => $globals['fonts'],
