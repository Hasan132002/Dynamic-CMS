...
function mainNav() {
  ...
  if (!$('.td_menu_toggle').length) {
    $('.td_nav').append('<span class="td_menu_toggle"><span></span></span>');
  }

  if (!$('.td_munu_dropdown_toggle').length) {
  ...
  $('.td_menu_toggle').on('click', function () {
    $(this).toggleClass('td_toggle_active');

    if ($(this).hasClass('td_toggle_active')) {
      $('.td_nav_list').slideDown(300);
    } else {
      $('.td_nav_list').slideUp(300);
    }
  });

  /* ✅ DROPDOWN TOGGLE */
  $('.td_munu_dropdown_toggle').on('click', function (e) {
    e.preventDefault();
    e.stopPropagation();
  ...
  /*--------------------------------------------------------------
    16. Sidebar Scroll (Degree Page)
  --------------------------------------------------------------*/
  function sidebarScroll() {
    if ($.exists('.td_sidebar_link')) {
      $('.td_sidebar_link').on('click', function(e) {
        e.preventDefault();

        // Remove active from all
        $('.td_sidebar_link').removeClass('active');
  ...
  --------------------------------------------------------------*/
  function faqToggle() {
    if ($.exists('.td_faq_question')) {
      $('.td_faq_question').on('click', function() {
        var $item = $(this).closest('.td_faq_item');
        var $answer = $item.find('.td_faq_answer');
        ...
        if ($item.hasClass('active')) {
          ...
          $('.td_faq_item.active').removeClass('active').find('.td_faq_answer').slideUp(300);
  ...
  /*--------------------------------------------------------------
    18. Featured Programs Carousel
  --------------------------------------------------------------*/
  function featuredCarousel() {
    if ($.exists('.td_featured_carousel_wrapper')) {
      var $wrapper = $('.td_featured_carousel_wrapper');
      var $track = $wrapper.find('.td_carousel_track');
      var $items = $track.find('.td_carousel_item');
      var $dotsContainer = $wrapper.find('.td_carousel_dots');
      var $prevBtn = $wrapper.find('.td_carousel_prev');
      var $nextBtn = $wrapper.find('.td_carousel_next');
      ...
      function createDots() {
        ...
        var totalDots = Math.ceil(totalItems / itemsToShow);

        for (var i = 0; i < totalDots; i++) {
          var activeClass = i === 0 ? 'active' : '';
          $dotsContainer.append('<span class="td_carousel_dot ' + activeClass + '" data-index="' + i + '"></span>');
        }
      }
      ...
      function updateCarousel() {
        ...
        var offset = currentIndex * itemsToShow * itemWidth;
        $track.css('transform', 'translateX(-' + offset + 'px)');

        // Update dots
        $dotsContainer.find('.td_carousel_dot').removeClass('active');
        $dotsContainer.find('.td_carousel_dot[data-index="' + currentIndex + '"]').addClass('active');
      }
      ...
      // Dot click
      $dotsContainer.on('click', '.td_carousel_dot', function() {
  ...
  /*--------------------------------------------------------------
    19. Counter Animation (Intersection Observer)
  --------------------------------------------------------------*/
  // Universal counter animation using Intersection Observer
  (function() {
    var counters = document.querySelectorAll('.td_counter, .td_counter_wsa');
    var speed = 50;
  ...
  /*--------------------------------------------------------------
    20. Video Section Background Image
  --------------------------------------------------------------*/
  // Set background image from data attribute
  (function() {
    var videoSections = document.querySelectorAll('.td_video_section[data-bg-image]');
    videoSections.forEach(function(section) {
      var bgImage = section.getAttribute('data-bg-image');
      if (bgImage) {
