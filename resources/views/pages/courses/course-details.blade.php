...
{{-- SECTIONS --}}
@sectionVisible($hero ?? [])
    @include('partials.courses.course-details.hero')
@endif
@sectionVisible($course ?? [])
    @include('partials.courses.course-details.course')
@endif
@sectionVisible($popular ?? [])
    @include('partials.courses.course-details.popular')
@endif
