...
<head>
  ...
  <title>Instructor Rrgistration</title>
...
{{-- SECTIONS --}}
@include('partials.pages.inner-pages.instructor-reg.hero')
@include('partials.pages.inner-pages.instructor-reg.instructor-reg')
