<section>
  <div
    class="td_video_block td_style_1 td_accent_bg td_bg_filed td_center text-center"
  ...
  >
    <div class="container">
      ...
      <h2
        class="td_fs_48 td_white_color mb-0 wow fadeInUp"
        data-wow-duration="1s"
        data-wow-delay="0.2s"
      >
        {!! $video['title'] !!}
    ...
    <div class="td_contact_box td_style_1 td_accent_bg td_radius_10">
      <div class="td_contact_box_left">
        <p class="td_fs_18 td_light td_white_color td_mb_4">
          {{ $video['contact']['email']['label'] }}
        </p>
        <h3 class="td_fs_36 mb-0 td_white_color">
          <a href="mailto:{{ $video['contact']['email']['value'] }}">
            {{ $video['contact']['email']['value'] }}
          </a>
        </h3>
      </div>
      ...
      <div class="td_contact_box_right">
        <p class="td_fs_18 td_light td_white_color td_mb_4">
          {{ $video['contact']['phone']['label'] }}
        </p>
        <h3 class="td_fs_36 mb-0 td_white_color">
          <a href="tel:{{ $video['contact']['phone']['value'] }}">
            {{ $video['contact']['phone']['value'] }}
          </a>
        </h3>
      </div>
    </div>
