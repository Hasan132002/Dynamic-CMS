        ...
        <div class="row td_gap_y_30 td_row_gap_30">
              ...
              <div class="td_card_info td_white_bg">
                <div class="td_card_info_in">
                  <ul class="td_card_meta td_mp_0 td_fs_18 td_medium td_heading_color">
                    <li>
                      <img src="{{ asset('storage/assets/img/icons/user_3.svg') }}" alt="">
                      <span class="td_opacity_7">150 Seats</span>
                    </li>
                    <li>
                      <img src="{{ asset('storage/assets/img/icons/book.svg') }}" alt="">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="td_card td_style_3 d-block td_radius_10">
              <span class="td_card_label td_accent_bg td_white_color">New</span>
              <a href="course-details.html" class="td_card_thumb">
                <img src="{{ asset('storage/assets/img/home_1/course_thumb_2.jpg') }}" alt="">
              </a>
              <div class="td_card_info td_white_bg">
                <div class="td_card_info_in">
                  <ul class="td_card_meta td_mp_0 td_fs_18 td_medium td_heading_color">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="td_card td_style_3 d-block td_radius_10">
              <span class="td_card_label td_accent_bg td_white_color">New</span>
              <a href="course-details.html" class="td_card_thumb">
                <img src="{{ asset('storage/assets/img/home_1/course_thumb_3.jpg') }}" alt="">
              </a>
              <div class="td_card_info td_white_bg">
                <div class="td_card_info_in">
                  <ul class="td_card_meta td_mp_0 td_fs_18 td_medium td_heading_color">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="td_card td_style_3 d-block td_radius_10">
              ...
              <a href="course-details.html" class="td_card_thumb">
                <img src="{{ asset('storage/assets/img/home_1/course_thumb_4.jpg') }}" alt="">
              </a>
              <div class="td_card_info td_white_bg">
                <div class="td_card_info_in">
                  <ul class="td_card_meta td_mp_0 td_fs_18 td_medium td_heading_color">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="td_card td_style_3 d-block td_radius_10">
              <span class="td_card_label td_accent_bg td_white_color">New</span>
              <a href="course-details.html" class="td_card_thumb">
                <img src="{{ asset('storage/assets/img/home_1/course_thumb_5.jpg') }}" alt=""> 
              </a>
              <div class="td_card_info td_white_bg">
                <div class="td_card_info_in">
                  <ul class="td_card_meta td_mp_0 td_fs_18 td_medium td_heading_color">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="td_card td_style_3 d-block td_radius_10">
              <span class="td_card_label td_accent_bg td_white_color">Best Seller</span>
              <a href="course-details.html" class="td_card_thumb">
                <img src="{{ asset('storage/assets/img/home_1/course_thumb_6.jpg') }}" alt=""> 
              </a>
              <div class="td_card_info td_white_bg">
                <div class="td_card_info_in">
                  <ul class="td_card_meta td_mp_0 td_fs_18 td_medium td_heading_color">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="td_card td_style_3 d-block td_radius_10">
              <span class="td_card_label td_accent_bg td_white_color">Best Seller</span>
              <a href="course-details.html" class="td_card_thumb">
                <img src="{{ asset('storage/assets/img/home_1/course_thumb_7.jpg') }}" alt="">
              </a>
              <div class="td_card_info td_white_bg">
                <div class="td_card_info_in">
                  <ul class="td_card_meta td_mp_0 td_fs_18 td_medium td_heading_color">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="td_card td_style_3 d-block td_radius_10">
              <a href="course-details.html" class="td_card_thumb">
                <img src="{{ asset('storage/assets/img/home_1/course_thumb_8.jpg') }}" alt="">
              </a>
              <div class="td_card_info td_white_bg">
                <div class="td_card_info_in">
                  <ul class="td_card_meta td_mp_0 td_fs_18 td_medium td_heading_color">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="td_card td_style_3 d-block td_radius_10">
              <a href="course-details.html" class="td_card_thumb">
                <img src="{{ asset('storage/assets/img/home_1/course_thumb_9.jpg') }}" alt="">
              </a>
              <div class="td_card_info td_white_bg">
                <div class="td_card_info_in">
                  <ul class="td_card_meta td_mp_0 td_fs_18 td_medium td_heading_color">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="td_card td_style_3 d-block td_radius_10">
              <a href="course-details.html" class="td_card_thumb">
                <img src="{{ asset('storage/assets/img/home_1/course_thumb_10.jpg') }}" alt="">
              </a>
              <div class="td_card_info td_white_bg">
                <div class="td_card_info_in">
                  <ul class="td_card_meta td_mp_0 td_fs_18 td_medium td_heading_color">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="td_card td_style_3 d-block td_radius_10">
              <a href="course-details.html" class="td_card_thumb">
                <img src="{{ asset('storage/assets/img/home_1/course_thumb_11.jpg') }}" alt="">
              </a>
              <div class="td_card_info td_white_bg">
                <div class="td_card_info_in">
                  <ul class="td_card_meta td_mp_0 td_fs_18 td_medium td_heading_color">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="td_card td_style_3 d-block td_radius_10">
              <a href="course-details.html" class="td_card_thumb">
                <img src="{{ asset('storage/assets/img/home_1/course_thumb_12.jpg') }}" alt="">
              </a>
              <div class="td_card_info td_white_bg">
                <div class="td_card_info_in">
                  <ul class="td_card_meta td_mp_0 td_fs_18 td_medium td_heading_color">
