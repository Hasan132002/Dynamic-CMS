  ...
  <div class="container">
    <div class="td_page_heading_in">
      <h1 class="td_white_color td_fs_48 td_mb_10 wow fadeInUp" data-wow-duration="1s">
        {!! $page['hero']['title'] ?? 'FINANCIAL AID' !!}
      </h1>

      <p class="td_fs_18 td_opacity_9 td_white_color wow fadeInUp td_hero_description" data-wow-duration="1s" data-wow-delay="0.2s">
        {{ $page['hero']['text'] ?? 'Explore financial aid options to make your education affordable.' }}
      </p>
    </div>
  </div>
