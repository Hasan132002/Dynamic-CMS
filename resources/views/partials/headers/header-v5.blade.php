<header class="td_site_header td_style_1 td_sticky_header td_medium td_heading_color">
      ...
      <div class="td_main_header_in">
        ...
        <div class="td_main_header_left">
          <a class="td_site_branding" href="{{ $logos['header']['link'] ?? url('/') }}">
            <img src="{{ asset(!empty($logos['header']['v5']) ? $logos['header']['v5'] : ($logos['header']['default'] ?? '')) }}" alt="Logo">
          </a>
        ...
        <div class="td_main_header_right">
          <div class="td_hero_toolbox_wrap">
            ...
            <a
              ...
              class="td_btn td_style_1 td_radius_10 td_medium td_with_shadow"
            >
