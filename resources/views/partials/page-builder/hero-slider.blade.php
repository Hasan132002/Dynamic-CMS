...
@if(!empty($slides))
<div class="td_hero_slider slick-slider" data-slick='{"slidesToShow": 1, "slidesToScroll": 1, "dots": true, "arrows": true, "autoplay": true, "autoplaySpeed": 5000, "fade": true}'>
    @foreach($slides as $slide)
        @php
            $background = $slide['background'] ?? 'assets/img/home_1/hero_bg_1.jpg';
            $title = $slide['title'] ?? '';
        ...
        <div class="td_hero_slide">
            <div class="td_hero td_style_1 td_heading_bg td_center td_bg_filed"
                 style="background-image: url('{{ asset($background) }}'); background-size: cover; background-position: center; min-height: 600px;">
                <div class="container">
                    <div class="td_hero_text wow fadeInRight" data-wow-duration="0.9s" data-wow-delay="0.35s">
                        ...
                        @if($title)
                            <h1 class="td_hero_title td_fs_64 td_white_color td_mb_20">
                                {!! $title !!}
                            </h1>
                        @endif
