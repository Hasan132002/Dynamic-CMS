@php($department = isset($department['data']) && is_array($department['data']) ? $department['data'] : $department)
  ...
  <div class="container">
    ...
    <div class="td_iconbox_1_wrap">
      @foreach($department['items'] as $item)
        <div class="td_iconbox td_style_1 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="{{ $item['delay'] }}">
          <div class="td_iconbox_icon td_accent_color td_mb_10">
            @include('svg.home-v1.department.' . $item['icon'])
          </div>
